...
1. `/drive-outcomes` — Stage 1+2 merged. Session A defines success criteria grounded in real fixture files and produces forensic `TASKS.md`; Session B implements in a worktree with compiler feedback and auto-review before commit.
